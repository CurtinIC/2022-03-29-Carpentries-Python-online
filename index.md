...
address: "Room 117, Building 501, Kent Street, Bentley"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "-32.008411"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "115.893396"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "NOV 16, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm AWST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2021-11-16      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2021-11-16        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Dan Marrable", "Paul Hancock", "Mortaza Rezae"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Nancy Tippaya", "Leigh Tyers", "Anik Roelofs"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: 181452157287     # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p id="who-can-attend">
    ...
    This workshop is open to affiliates to Curtin University.
</p>
